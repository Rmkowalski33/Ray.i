...
if ($gitBashPath) {
    ...
    Write-Host ""
    Write-Host "You may need to request Git installation from IT" -ForegroundColor Yellow
    exit 1
}
...
Write-Host ""
Write-Host "Git Bash path set to: $gitBashPath" -ForegroundColor Gray